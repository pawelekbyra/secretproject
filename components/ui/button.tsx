...
const buttonVariants = cva(
  `inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold tracking-tight transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[${TAP_SCALE}]`,
  {
    variants: {
      variant: {
        ...
        outlineWhite:
          "border border-white/60 bg-transparent text-white hover:bg-white/10 hover:border-white shadow-[0_0_10px_-3px_rgba(255,255,255,0.2)] hover:shadow-[0_0_15px_-2px_rgba(255,255,255,0.3)]",
        secondary:
